...
const buttonVariants = cva(
    //? add uppercase tracking-wide font-bold to the default class
    "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide font-bold",
    {
        variants: {
            variant: {
                default:
            ...
            size: {
                ...
                //? remove rounded-md
                sm: "h-9 px-3",
                //? change h-11 to h-12 and remove rounded-md
                lg: "h-12 px-8",
                icon: "h-10 w-10",
                //? add rounded size
